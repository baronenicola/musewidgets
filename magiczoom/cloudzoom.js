...
if (r.event.fixHooks)
	for (var v = s.length; v; )
		r.event.fixHooks[s[--v]] = r.event.mouseHooks;
r.event.special.mousewheel = {
	setup : function () {
		if (this.addEventListener)
			for (var a = s.length; a; )
				this.addEventListener(s[--a], t, k);
		else
			this.onmousewheel = t
	},
	teardown : function () {
		if (this.removeEventListener)
			for (var a = s.length; a; )
				this.removeEventListener(s[--a], t, k);
		else
			this.onmousewheel = j
	}
};
...
function z(a) {
	for (var c = "", b, d = y("charCodeAt"), e = a[d](0) - 32, g = 1; g < a.length - 1; g++)
		b = a[d](g), b ^= e & 31, e++, c += String[y("fromCharCode")](b);
	a[d](g);
	return c
}
function A(a, c) {
...
function J(a, c) {
	...
	this.Ga = {
		...
		la : function (a) {
			var b = "";
			if ("touchend" == a.type || 2 != a.touches.length)
				return l = m = j;
...
J.prototype.ra = function (a) {
	...
	for (c = 0; c < this.m.length; c++)
		a[c] = this.m[b], b++, b >= this.m.length && (b = 0);
	return a
};
...
q.ea = function () {
	if (this.options.disableZoom === k)
		return k;
	if (this.options.disableZoom === h)
		return h;
		...
		if (!a.T) {
			...
			r(document).bind("mousemove." + this.id, function (b) {
				if (a.b != j) {
					...
					if (-1 > b.x || b.x > a.d || 0 > b.y || b.y > a.c)
						a.b.remove(), a.t(), a.b = j;
					a.W = b
				}
			});
			a.Q();
...
q.w = function () {
	...
	g = a.g,
	n = a.caption;
	if ("inside" == a.options.zoomPosition)
		c.width(a.d / a.e * a.d), c.height(a.c / a.g * a.c), c.css("display", "none"), a.h = new L({
				zoom : a,
...
r.fn.CloudZoom = function (a) {
	return this.each(function () {
		if (r(this).hasClass("cloudzoom-gallery")) {
			...
			r(this).data("CloudZoom", new J(r(this), a))
	})
};
